...
########## COMPONENT stacktrace_windbg_cached TARGET PROPERTIES ######################################

set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_LINK_LIBRARIES
             $<$<CONFIG:Debug>:${Boost_stacktrace_windbg_cached_LINK_LIBS_DEBUG}
                ${Boost_stacktrace_windbg_cached_LINKER_FLAGS_LIST_DEBUG}>
             $<$<CONFIG:Release>:${Boost_stacktrace_windbg_cached_LINK_LIBS_RELEASE}
                ${Boost_stacktrace_windbg_cached_LINKER_FLAGS_LIST_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:${Boost_stacktrace_windbg_cached_LINK_LIBS_RELWITHDEBINFO}
                ${Boost_stacktrace_windbg_cached_LINKER_FLAGS_LIST_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:${Boost_stacktrace_windbg_cached_LINK_LIBS_MINSIZEREL}
                ${Boost_stacktrace_windbg_cached_LINKER_FLAGS_LIST_MINSIZEREL}>)
set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_INCLUDE_DIRECTORIES
             $<$<CONFIG:Debug>:${Boost_stacktrace_windbg_cached_INCLUDE_DIRS_DEBUG}>
             $<$<CONFIG:Release>:${Boost_stacktrace_windbg_cached_INCLUDE_DIRS_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:${Boost_stacktrace_windbg_cached_INCLUDE_DIRS_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:${Boost_stacktrace_windbg_cached_INCLUDE_DIRS_MINSIZEREL}>)
set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_COMPILE_DEFINITIONS
             $<$<CONFIG:Debug>:${Boost_stacktrace_windbg_cached_COMPILE_DEFINITIONS_DEBUG}>
             $<$<CONFIG:Release>:${Boost_stacktrace_windbg_cached_COMPILE_DEFINITIONS_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:${Boost_stacktrace_windbg_cached_COMPILE_DEFINITIONS_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:${Boost_stacktrace_windbg_cached_COMPILE_DEFINITIONS_MINSIZEREL}>)
set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_COMPILE_OPTIONS
             $<$<CONFIG:Debug>:
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_C_DEBUG}
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_CXX_DEBUG}>
             $<$<CONFIG:Release>:
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_C_RELEASE}
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_CXX_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_C_RELWITHDEBINFO}
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_CXX_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_C_MINSIZEREL}
                 ${Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_CXX_MINSIZEREL}>)
set(Boost_stacktrace_windbg_cached_TARGET_PROPERTIES TRUE)

########## COMPONENT stacktrace_windbg TARGET PROPERTIES ######################################

set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_LINK_LIBRARIES
             $<$<CONFIG:Debug>:${Boost_stacktrace_windbg_LINK_LIBS_DEBUG}
                ${Boost_stacktrace_windbg_LINKER_FLAGS_LIST_DEBUG}>
             $<$<CONFIG:Release>:${Boost_stacktrace_windbg_LINK_LIBS_RELEASE}
                ${Boost_stacktrace_windbg_LINKER_FLAGS_LIST_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:${Boost_stacktrace_windbg_LINK_LIBS_RELWITHDEBINFO}
                ${Boost_stacktrace_windbg_LINKER_FLAGS_LIST_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:${Boost_stacktrace_windbg_LINK_LIBS_MINSIZEREL}
                ${Boost_stacktrace_windbg_LINKER_FLAGS_LIST_MINSIZEREL}>)
set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_INCLUDE_DIRECTORIES
             $<$<CONFIG:Debug>:${Boost_stacktrace_windbg_INCLUDE_DIRS_DEBUG}>
             $<$<CONFIG:Release>:${Boost_stacktrace_windbg_INCLUDE_DIRS_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:${Boost_stacktrace_windbg_INCLUDE_DIRS_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:${Boost_stacktrace_windbg_INCLUDE_DIRS_MINSIZEREL}>)
set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_COMPILE_DEFINITIONS
             $<$<CONFIG:Debug>:${Boost_stacktrace_windbg_COMPILE_DEFINITIONS_DEBUG}>
             $<$<CONFIG:Release>:${Boost_stacktrace_windbg_COMPILE_DEFINITIONS_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:${Boost_stacktrace_windbg_COMPILE_DEFINITIONS_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:${Boost_stacktrace_windbg_COMPILE_DEFINITIONS_MINSIZEREL}>)
set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_COMPILE_OPTIONS
             $<$<CONFIG:Debug>:
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_C_DEBUG}
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_CXX_DEBUG}>
             $<$<CONFIG:Release>:
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_C_RELEASE}
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_CXX_RELEASE}>
             $<$<CONFIG:RelWithDebInfo>:
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_C_RELWITHDEBINFO}
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_CXX_RELWITHDEBINFO}>
             $<$<CONFIG:MinSizeRel>:
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_C_MINSIZEREL}
                 ${Boost_stacktrace_windbg_COMPILE_OPTIONS_CXX_MINSIZEREL}>)
set(Boost_stacktrace_windbg_TARGET_PROPERTIES TRUE)
...
foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_cached_BUILD_MODULES_PATHS_DEBUG})
    include(${_BUILD_MODULE_PATH})
endforeach()

foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_cached_BUILD_MODULES_PATHS_RELEASE})
    include(${_BUILD_MODULE_PATH})
endforeach()

foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_cached_BUILD_MODULES_PATHS_RELWITHDEBINFO})
    include(${_BUILD_MODULE_PATH})
endforeach()

foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_cached_BUILD_MODULES_PATHS_MINSIZEREL})
    include(${_BUILD_MODULE_PATH})
endforeach()

########## COMPONENT stacktrace_windbg BUILD MODULES ##########################################

foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_BUILD_MODULES_PATHS_DEBUG})
    include(${_BUILD_MODULE_PATH})
endforeach()

foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_BUILD_MODULES_PATHS_RELEASE})
    include(${_BUILD_MODULE_PATH})
endforeach()

foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_BUILD_MODULES_PATHS_RELWITHDEBINFO})
    include(${_BUILD_MODULE_PATH})
endforeach()

foreach(_BUILD_MODULE_PATH ${Boost_stacktrace_windbg_BUILD_MODULES_PATHS_MINSIZEREL})
    include(${_BUILD_MODULE_PATH})
endforeach()
